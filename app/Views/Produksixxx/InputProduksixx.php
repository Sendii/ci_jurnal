        ...
        <?= form_open('Produksi') ?>
				...
				<div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('satuan_bop') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('satuan_bop')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="satuan_bop" name="satuan_bop" value="<?= set_value('satuan_bop')?>" placeholder="Diisi dengan satuan BOP">
                </div>
				<div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('qty_bop') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('qty_bop')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="qty_bop" name="qty_bop" value="<?= set_value('qty_bop')?>" placeholder="Diisi dengan Quantity BOP">
                </div>
				<div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('harga_bop') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('harga_bop')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="harga_bop" name="harga_bop" value="<?= set_value('harga_bop')?>" placeholder="Diisi dengan Harga BOP">
                </div>
				 ...
				 <div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('nama_karyawan') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('nama_karyawan')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
				...
				<div class="mb-3">
                    <label for="satuan_karyawan" class="form-label">Tarif Tenaga Kerja</label>
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('satuan_karyawan') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('satuan_karyawan')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="satuan_karyawan" name="satuan_karyawan" value="<?= set_value('satuan_karyawan')?>" placeholder="Diisi dengan tarif tenaga kerja perhari">
                </div>
				<div class="mb-3">
                    <label for="qty_karyawan" class="form-label">Jumlah hari kerja Tenaga Kerja</label>
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('qty_karyawan') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('qty_karyawan')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="qty_karyawan" name="qty_karyawan" value="<?= set_value('qty_karyawan')?>" placeholder="Diisi dengan Jumlah hari kerja Tenaga Kerja">
                </div>
				<div class="mb-3">
                    <label for="harga_karyawan" class="form-label">Total tarif Tenaga Kerja</label>
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('harga_karyawan') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('harga_karyawan')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="harga_karyawan" name="harga_karyawan" value="<?= set_value('harga_karyawan')?>" placeholder="Diisi dengan Total Tarif Tenaga Kerja">
                </div>
				
				
				 <div class="mb-3">
                    <label for="biayaproduksi" class="form-label">Total Biaya Produksi</label>
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field namakosan
                            if ( $validation->hasError('biayaproduksi') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('biayaproduksi')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="biayaproduksi" name="biayaproduksi" value="<?= set_value('biayaproduksi')?>" placeholder="Total Biaya Produksi">
                </div>
