               ...
               <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <?php
                        if(isset($validation)){
                            //untuk mengecek apakah ada error pada elemen field nama_produk
                            if ( $validation->hasError('nama_pembeli') )
                            { //untuk mendapatkan label error yang diset bisa menggunakan getError(namfield)
                                ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error: <?=$validation->getError('nama_pembeli')?> </strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                            <?php
                            }
                    ...
                    ?>
                    <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli" value="<?= set_value('nama_pembeli')?>" placeholder="Diisi dengan nama pembeli produk">
                </div>
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="number" class="form-control" id="jumlah" name="jumlah" value="<?= set_value('jumlah')?>" placeholder="Diisi dengan jumlah yang dijual" onkeyup="myFunction();">
                </div>
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="harga" name="harga" value="<?= set_value('harga')?>" placeholder="Diisi dengan harga produk yang djual" onkeyup="myFunction();">
                </div>
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="hpp" name="hpp" value="<?= set_value('hpp')?>" placeholder="Diisi dengan HPP Produk" onkeyup="myFunction();">
                </div>

                <div class="mb-3">
                    <label for="total" class="form-label">Laba</label>
                    <input type="text" class="form-control" id="total" name="total" value="<?= set_value('total')?>" placeholder="Jumlah HPP dan Harga Produk" onkeyup="myFunction();">
                </div>
